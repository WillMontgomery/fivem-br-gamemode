...
AddEventHandler('onResourceStart', function(res)
    ...
    -- Our own scheduler instance, not br_core's. Separate Lua state, separate
    -- job registry, separate /brperf accounting -- so a wedged moderation job
    -- is invisible to the gamemode's numbers, and a br_core fault does not stop
    -- this clock.
    BR.Sched.start()
