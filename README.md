...
| **Container** | A chest or a death box. Holds a rolled burst of items that the client is never told about — the contents are the reason to open it — and opening one takes a held key, so it is a commitment in the open. |
